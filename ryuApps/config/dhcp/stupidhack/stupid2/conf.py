...
DHCP_SERVER_IP = '192.168.2.1'

#The database-engine to use
#For details, see the configuration guide in the documentation.
DATABASE_ENGINE = 'INI'
INI_FILE = '/home/laurence/Thesis/staticdhcpd/lease.ini'
#INI_FILE = '/home/laurence/Thesis/proto_mud/staticdhcpd/staticDHCPd/databases/dhcp.ini'
